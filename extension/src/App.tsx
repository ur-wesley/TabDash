...
import widgetAppearance from "./api/widgetAppearance.js";
...
const App: Component = () => {
  ...
  const setTheme = () => {
    ...
    widgetAppearance($store().widgetSetting[activeTheme]);
  };
  ...
  return (
    <div class="h-screen w-screen overflow-hidden">
      <Show when={!!$store().general}>
        ...
        >
          <Match
            when={$store().background.active || $store().background.static}
          >
            <img
            ...
            />
            <img
              src={$store().background.image.next}
              class="hidden"
              loading="lazy"
            />
          </Match>
        ...
        <div
          class="h-full w-full flex flex-col items-center justify-evenly overflow-hidden"
          id="content"
        >
          <Show
            when={
